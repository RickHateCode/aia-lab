...
const HeroSection = ()=> {
    ...
    <div id="Acceuil">
       <div className=" w-full  relative md:relative  mx-auto" >
            <div ><img src="/aia-lab/images/bgNoirT.jpg" height = {500} alt="" className=""/></div>'
            <div className="absolute inset-0  bg-black opacity-85 mx-auto"/>
            <div className="absolute inset-0 flex items-center justify-center ">
            <img src="/aia-lab/images/aiapng.png"  alt="" className=" w-full max-w-56 sm:max-w-72 md:max-w-80 lg:max-w-[24rem] xl:max-w-[30rem]"/>
            </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center ">
          ...
          <div className="relative">
            <img
              src="/aia-lab/images/Keyboard.jpg"
